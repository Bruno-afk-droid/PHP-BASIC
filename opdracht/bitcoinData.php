...
if (isset($_GET['euro'])) {
    ...
    $button = array($D,$buttons[0],$buttons[0]/$D);
    array_push($transactions,$button);
    $button = array($D,$buttons[1],$buttons[1]/$D);
    array_push($transactions,$button);
    $button = array($D,$buttons[2],$buttons[2]/$D); 
    array_push($transactions,$button);
    //array_push($transactions,$D,$buttons[0],$D/$buttons[1]);
    //array_push($transactions,$D,$buttons[0],$D/$buttons[2]);
}
